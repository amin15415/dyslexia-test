...
const phoneticTestWords = {
    ...
    'does': [['d','ʌ','z']], 'listen': [['l','ɪ','s','ə','n']], 'city': [['s','ɪ','t','i']], 'animal': [['æ','n','ɪ','m','ə','l']], 'light': [['l','aɪ','t']], 'uncle': [['ʌ','ŋ','k','ə','l']], 'rolled': [['r','oʊ','l','d']],
    'calf': [['k','æ','f'], ['k','ɑ','f']], 'enough': [['ɪ','n','ʌ','f']], 'meadow': [['m','ɛ','d','oʊ']], 'heavy': [['h','ɛ','v','i']], 'business': [['b','ɪ','z','n','ɪ','s']], 'believe': [['b','ɪ','l','i','v']], 'laugh': [['l','æ','f']],
    'delight': [['d','ɪ','l','aɪ','t']], 'familiar': [['f','ə','m','ɪ','l','i','ə','r']], 'rough': [['r','ʌ','f']], 'glisten': [['g','l','ɪ','s','ə','n']], 'league': [['l','i','g']], 'spectacles': [['s','p','ɛ','k','t','ə','k','ə','l','s']], 'decorate': [['d','ɛ','k','ə','r','eɪ','t']],
    'cautious': [['k','ɔ','ʃ','ə','s']], 'ancient': [['eɪ','n','ʃ','ə','n','t']], 'toughen': [['t','ʌ','f','ə','n']], 'height': [['h','aɪ','t']], 'doubt': [['d','aʊ','t']], 'position': [['p','ə','z','ɪ','ʃ','ə','n']], 'contagious': [['k','ə','n','t','eɪ','dʒ','ə','s']],
    'conceited': [['k','ə','n','s','i','t','ɪ','d']], 'foreign': [['f','ɔ','r','ɪ','n']], 'knapsack': [['n','æ','p','s','æ','k']], 'decisions': [['d','ɪ','s','ɪ','ʒ','ə','n','s']], 'allegiance': [['ə','l','i','dʒ','ə','n','s']], 'leisure': [['l','ɛ','ʒ','ə','r'], ['l','i','ʒ','ə','r']], 'deny': [['d','ɪ','n','aɪ']],
    ...
    'pollute': [['p','ə','l','u','t']], 'exonerate': [['ɪ','g','z','ɒ','n','ə','r','eɪ','t']], 'risible': [['r','ɪ','z','ɪ','b','ə','l']], 'regime': [['r','eɪ','ʒ','i','m']], 'endeavor': [['ɪ','n','d','ɛ','v','ə','r']], 'islet': [['aɪ','l','ə','t']], 'heinous': [['h','eɪ','n','ə','s']],
    ...
    'homeopathy': [['h','oʊ','m','i','oʊ','p','æ','θ','i']], 'evanesce': [['ɪ','v','ə','n','ɛ','s']], 'geodesy': [['dʒ','i','oʊ','d','ɛ','s','i']], 'coulomb': [['k','u','l','ɒ','m']], 'zoophyte': [['z','oʊ','ə','f','aɪ','t']], 'execrable': [['ɛ','k','s','ɪ','k','r','ə','b','ə','l']], 'triptych': [['t','r','ɪ','p','t','ɪ','k']],
    ...
    'exiguous': [['ɪ','g','z','ɪ','g','w','ə','s']], 'malapropos': [['m','æ','l','ə','p','r','oʊ']], 'ytterbium': [['ɪ','t','ər','b','i','ə','m']], 'monocotyledon': [['m','ɒ','n','ə','k','ɒ','t','ə','l','ɪ','d','ə','n']], 'leitmotif': [['l','aɪ','t','m','oʊ','t','i','f']], 'egregious': [['ɪ','g','r','i','dʒ','ə','s']], 'legerdemain': [['l','ɛ','dʒ','ər','d','ə','m','eɪ','n']]
};
